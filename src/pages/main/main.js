...
export default class Main extends Component {
    ...
    loadAShows = async () => {
        try {
            const response = await api.get('/occurrences/viewOpenDemands');
    ...
    filedAShow= async (ashow) => {
        try {
            const response = await api.put(`/occurrences/forwardinit/${ashow.id}`)
            .catch(
                () => alert('Houve um problema ao iniciar a AShow!')
            );
    ...
    renderItem = ({ item }) => (
        <View style={styles.ashowContainer}>
            ...
            <Modal
                ...
                <View style={{marginTop: 80, marginHorizontal: 15}}>
                    <View>
                    ...
                    <View style={styles.viewButtonsModal}>
                        ...
                        <TouchableHighlight
                            ...
                            onPress={() => {
                                this.buttonFiledClickded(this.state.ashowSelected);
                            }}>
                            <Text style={styles.ashowButtonText}>Iniciar</Text>
                        </TouchableHighlight>
